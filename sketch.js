...
function setup() {
	...
	bobObject1=new Bobs(startBobPositionX-bobDiameter*2,startBobPositionY,bobDiameter);
	bobObject2=new Bobs(startBobPositionX-bobDiameter,startBobPositionY,bobDiameter);
	bobObject3=new Bobs(startBobPositionX,startBobPositionY,bobDiameter);
	bobObject4=new Bobs(startBobPositionX+bobDiameter,startBobPositionY,bobDiameter);
	bobObject5=new Bobs(startBobPositionX+bobDiameter*2,startBobPositionY,bobDiameter);
